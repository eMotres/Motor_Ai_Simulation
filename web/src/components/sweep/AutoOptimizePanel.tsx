  ...
  return (
    <Card variant="outlined" sx={{ mb: 2, borderColor: 'rgba(34,197,94,0.45)' }}>
      <CardContent sx={{ py: 1.5, '&:last-child': { pb: 1.5 } }}>
        ...
        {/* ── EVERY EVALUATED DESIGN, as a table (Sweep's, on this run) ──────
             Rendered DURING the run as well as after it: the question "what is
             it actually changing" is asked while the search is still going, and
             the charts cannot answer it. */}
        <AutoPointsTable points={(st.points || []) as any[]} gate={gate}
          rpm={Number(op?.rpm) || undefined} />
